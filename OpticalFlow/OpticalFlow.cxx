...
int main( int argc, char **argv ) {
	...
	opticalFlow->SetLambdaXY( 3000 );
	opticalFlow->SetLambdaZ( 15000 );
	opticalFlow->SetLambdaW( 200000 );
	opticalFlow->SetThreshold( 1.0 ); //Default 1.0
	opticalFlow->SetIterations( 3 );  //Default 5
